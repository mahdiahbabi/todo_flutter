...
class _EditTaskState extends State<EditTask> {
  DateTime dateTime = DateTime(2040, 2, 1);
  DateTime dateTime_time = DateTime(2040, 2, 1, 10, 20);

  TextEditingController _controller_tasktitle = TextEditingController();
  TextEditingController _controller_taskdetail = TextEditingController();
  ...
  void initState() {
    ...
    task.categori = widget.taskData.categori;
    task.iscompleted = widget.taskData.iscompleted;
    _controller_tasktitle.text = widget.taskData.TaskTitle;
    _controller_taskdetail.text = widget.taskData.TaskDetail;
  }
